        ...
        >
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="space-y-1 min-w-0 flex-1">
              <h3 id="confirm-dialog-title" className="text-base font-black text-slate-900 dark:text-slate-100">
                {title}
              </h3>
              <p id="confirm-dialog-desc" className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                {message}
              </p>
            </div>
          </div>
