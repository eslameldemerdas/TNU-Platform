...
export class RateLimitError extends AppError {
  constructor(message = 'Too many requests. Please slow down and try again later.', retryAfterSeconds?: number) {
...
export function errorHandler(
  ...
  console.error(`[API_ERROR] [${req.method}] ${req.originalUrl} - Status: ${statusCode} - Code: ${payload.error.code} - Msg: ${payload.error.message}`);
